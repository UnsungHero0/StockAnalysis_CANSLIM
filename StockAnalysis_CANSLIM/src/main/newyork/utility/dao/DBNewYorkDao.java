...
public class DBNewYorkDao {
	...
	public static ArrayList<String> getCodeListFromDB(Connection con) {
		...
		String getCodeListSql = "SELECT Local_Code FROM " + namespace.NewYorkDBNameSpace.getListedcompaniesNewYorkDb();
		ResultSet rs = null;
		try {
	...
	public static String getNameEnglish(String code, Connection con) {
		String result = "";
		String getNameEnglishSql = "SELECT * FROM " + namespace.NewYorkDBNameSpace.getListedcompaniesNewYorkDb() + " WHERE Local_Code = '" + code + "'";
		ResultSet rs = null;
		try {
